...
public class DeptTable7_dap extends JFrame implements ActionListener {
	// 선언부
	...
	JTable7Dialog_dap jtd7 = new JTable7Dialog_dap(this);
	...
	public void refreshData() {
		...
		if(DeptTable7_dap.vdata.size() <=0){
	...
	public void actionPerformed(ActionEvent e) {
		...
		//너 입력 버튼 누른거야?
			...
			jtd7.set("입력",true,null);//다이얼로그에서 값을 받아옴????
		}
		//너 수정 할려구?
