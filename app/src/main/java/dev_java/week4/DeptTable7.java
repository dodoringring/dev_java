...
public class DeptTable7 extends JFrame implements ActionListener {
  ...
  public void refreshData() {
    ...
    for (int i = 0; i < vdata.size(); i++) {
      DeptVO oneRow = vdata.get(i);//// 들어간는데 버튼누르
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    // 너 수정할려고?
      ...
      DeptVO pdVO = vdata.get(index);// 한줄씩 꺼내오기
    ...
    // 너 상세보기원해?
      ...
      if (index == 1) {
        JOptionPane.showMessageDialog(this, "상세보기 할 것을 선택해줘");
        return;// actionPerformd탈출함
      }
      // 벡터안에 사용자가 선택한 DeptVO를 찾아야 하니까.... 그러니까 선택하라구
